...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.country_grouping'
        db.alter_column(u'FaraData_location', 'country_grouping', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Location.country_grouping'
        db.alter_column(u'FaraData_location', 'country_grouping', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
