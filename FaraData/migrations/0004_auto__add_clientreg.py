...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientReg'
        db.create_table(u'FaraData_clientreg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['FaraData.Client'])),
            ('reg_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['FaraData.Registrant'])),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'FaraData', ['ClientReg'])

        # Adding M2M table for field primary_contractor_id on 'ClientReg'
        m2m_table_name = db.shorten_name(u'FaraData_clientreg_primary_contractor_id')
        ...
        db.create_unique(m2m_table_name, ['clientreg_id', 'registrant_id'])
    ...
    def backwards(self, orm):
        # Deleting model 'ClientReg'
        db.delete_table(u'FaraData_clientreg')

        # Removing M2M table for field primary_contractor_id on 'ClientReg'
        db.delete_table(db.shorten_name(u'FaraData_clientreg_primary_contractor_id'))
    ...
    models = {
        ...
        u'FaraData.clientreg': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'files': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['FaraData.MetaData']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
