...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field meta_data on 'Registrant'
        m2m_table_name = db.shorten_name(u'FaraData_registrant_meta_data')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('registrant', models.ForeignKey(orm[u'FaraData.registrant'], null=False)),
            ('metadata', models.ForeignKey(orm[u'FaraData.metadata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['registrant_id', 'metadata_id'])
        ...
        # Adding M2M table for field meta_data on 'ClientReg'
        m2m_table_name = db.shorten_name(u'FaraData_clientreg_meta_data')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        # Adding M2M table for field meta_data on 'Client'
        m2m_table_name = db.shorten_name(u'FaraData_client_meta_data')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('client', models.ForeignKey(orm[u'FaraData.client'], null=False)),
            ('metadata', models.ForeignKey(orm[u'FaraData.metadata'], null=False))
        ))
        db.create_unique(m2m_table_name, ['client_id', 'metadata_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field meta_data on 'Registrant'
        db.delete_table(db.shorten_name(u'FaraData_registrant_meta_data'))
        ...
        # Removing M2M table for field meta_data on 'ClientReg'
        db.delete_table(db.shorten_name(u'FaraData_clientreg_meta_data'))

        # Removing M2M table for field meta_data on 'Client'
        db.delete_table(db.shorten_name(u'FaraData_client_meta_data'))
