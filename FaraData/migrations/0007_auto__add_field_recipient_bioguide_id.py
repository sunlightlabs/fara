...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipient.bioguide_id'
        db.add_column(u'FaraData_recipient', 'bioguide_id',
                      self.gf('django.db.models.fields.CharField')(max_length=7, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipient.bioguide_id'
        db.delete_column(u'FaraData_recipient', 'bioguide_id')
