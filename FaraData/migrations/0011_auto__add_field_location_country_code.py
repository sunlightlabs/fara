...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.country_code'
        db.add_column(u'FaraData_location', 'country_code',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.country_code'
        db.delete_column(u'FaraData_location', 'country_code')
