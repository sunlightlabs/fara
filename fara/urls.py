...
urlpatterns = patterns('',
    ...
    url(r'^make_clone_contact','FaraData.entry_view.make_clone_contact', name='make-clone-contact'),
    #Easy fix forms
    ...
    url(r'^clone_contact/(\d+)','FaraData.entry_view.clone_contact', name='clone-contact'),
